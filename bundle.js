...
/***/ function(module, exports, __webpack_require__) {
	...
	(0, _reactDom.render)(_react2.default.createElement(
	    ...
	    _react2.default.createElement(_reactRouter.Route, { path: '/', component: _Menu.App })
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.Plot = exports.Inspect = exports.Load = exports.App = undefined;
	...
	var _reactDropzone = __webpack_require__(217);
	...
	var Nav = function (_React$Component2) {
	    ...
	    function Nav(props) {
	        ...
	        _this2.state = _this2.props.state;
	        return _this2;
	    }
	    ...
	    _createClass(Nav, [{
	        ...
	        value: function render() {
	            ...
	            var Inspect = _state.Inspect;
	            var Plot = _state.Plot;
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        'div',
	                        { className: "tab-item " + (Load ? "active" : ""), onClick: this.props.onClick },
	                        _react2.default.createElement('span', { className: 'icon' }),
	                        'Load'
	                    ),
	                    _react2.default.createElement(
	                        'div',
	                        { className: "tab-item " + (Inspect ? "active" : ""), onClick: this.props.onClick },
	                        _react2.default.createElement('span', { className: 'icon' }),
	                        'Inspect'
	                    ),
	                    _react2.default.createElement(
	                        'div',
	                        { className: "tab-item " + (Plot ? "active" : ""), onClick: this.props.onClick },
	                        _react2.default.createElement('span', { className: 'icon' }),
	                        'Plot'
	                    )
	                )
	...
	var App = function (_React$Component3) {
	    ...
	    _createClass(App, [{
	        key: 'openFile',
	        value: function openFile(files) {
	            var fileName = files[0].path;
	            var data = fs.readFileSync(fileName);
	            var lines = data.toString().split('\n');
	            var splitData = lines.map(function (each) {
	                var line = each.split(' ');
	                return line.filter(function (elem) {
	                    return elem != '';
	                });
	            });
	        ...
	        value: function onClick(event) {
	            var name = event.target.children[1].innerHTML;
	        ...
	        value: function render() {
	            ...
	            if (visible.Load) {
	                return _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(Load, { onDrop: this.openFile })
	                );
	                ...
	                return _react2.default.createElement(
	                    ...
	                    null,
	                    _react2.default.createElement(Nav, { state: visible, onClick: this.onClick }),
	                    _react2.default.createElement(Plot, { data: data })
	                );
	            }
	        }
	    }]);
	...
	var Load = function (_React$Component4) {
	    _inherits(Load, _React$Component4);
	
	    function Load() {
	        _classCallCheck(this, Load);
	
	        return _possibleConstructorReturn(this, Object.getPrototypeOf(Load).apply(this, arguments));
	    }
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    ...
	                    { style: { width: '100%', bottom: '0', top: '0', position: 'absolute', cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center' }, onDrop: this.props.onDrop },
	                    _react2.default.createElement(
	                        'h1',
	                        { style: { fontSize: '4vw', cursor: 'pointer', margin: '0 10% 0' } },
	                        'Drag or click anywhere to load data.'
	                    )
	                )
	            );
	        }
	...
	var Inspect = function (_React$Component5) {
	    _inherits(Inspect, _React$Component5);
	
	    function Inspect() {
	        _classCallCheck(this, Inspect);
	
	        return _possibleConstructorReturn(this, Object.getPrototypeOf(Inspect).apply(this, arguments));
	    }
	...
	var Plot = function (_React$Component6) {
	    _inherits(Plot, _React$Component6);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _attrAccept = __webpack_require__(218);
